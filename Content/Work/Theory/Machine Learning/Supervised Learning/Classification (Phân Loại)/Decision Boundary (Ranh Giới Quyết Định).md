...
đây là đường thẳng (hoặc mặt phẳng và cao hơn) , để phân tách giữa hai cụm 0 và 1, các điểm trên đường này có giá trị của [[Hypothesis (hàm dự đoán)]] là 0.5 tức là xác suất để nó có nhãn 1 và nhãn 0 là 0.5
...
\end{align} 
$$
với $f_{{\vec{w}, b}}(\vec{x})$ là hypothesis của [[Logistic Regression (Hồi Quy Logistic)]] 
