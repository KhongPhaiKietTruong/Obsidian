...
- $x_{2}$ $\in$ \[1, 5]
- 
[[Hypothesis (hàm dự đoán)]] của ta có dạng: $$f_{\vec{w}, b}(\vec{x}) = w_{1} x_{1} + w_{2}x_{2} + b$$ta có [[Cost Function]] (giả sử ta dùng [[Mean Squared Error Cost Function (MSE)]]) là:
$$ 
