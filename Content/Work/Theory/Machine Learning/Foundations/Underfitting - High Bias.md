...
hiện tượng này có thể được nhận biết thông qua tính [[Training Error]] và [[Validation Error]], khi training error cao và validation error cũng cao (hai đại lượng này xấp xỉ nhau) (xem thêm [[Mối quan hệ giữa Trainning Error và Validation Error]])
