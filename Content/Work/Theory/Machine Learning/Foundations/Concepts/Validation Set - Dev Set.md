khi ta huấn luyện một mô hình, ta sẽ thử mô hình đó với nhiều [[Linear equation |phương trình tuyến tính]] khác nhau trong mỗi [[Neural]] ([[Polynomial Regression (Đặc Trưng Đa Thức)]]) thay vì chỉ dạng cơ bản là 
$$
z = \vec{x}\vec{w}+b
$$
