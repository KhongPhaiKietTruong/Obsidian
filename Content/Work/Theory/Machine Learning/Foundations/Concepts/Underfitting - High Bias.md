...
- hiện tượng này có thể được nhận biết thông qua tính [[Train Error]] và [[Val Error - Dev Error]], khi train error sấp xỉ val error và cả hai đều ở mức cao thì model bị underfit (cao ở đây nghĩa là nó cao với [[Human-level Error]] ) 
