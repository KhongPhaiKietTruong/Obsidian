...
- hiện tượng này có thể được nhận biết thông qua tính [[Train Error]] và [[Val Error - Dev Error]], khi train error sấp xỉ val error và cả hai đều ở mức cao thì model bị underfit %% hehe %% (xem thêm [[Mối quan hệ giữa Trainning Error và Validation Error trong Degree Of Polynominal]])
