...
ở mỗi timestamp, thì ta truyền vào giá trị  $x^{<t>}=y^{<t-1>}$ là [[Target Value]] tại vị trí nằm trước vị trí hiện tại, $a^{<t-1>}$ là tóm tắt thông tin của các timestamp trước từ đó ta tính được [[Pre-activation Value z]] của vị trí hiện tại 
