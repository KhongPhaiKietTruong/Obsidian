...
ta thường pretrain trên một lượng liệu rất lớn để học được các word embeddings, rồi dùng các word ebeddings đó để tiếp tục thực hiện [[Transfer Learning (Học Chuyển Giao)]] 
