...
sau khi ta tính ra được output của mỗi hướng đi, ta sẽ thực hiện ghép chúng nó lại trên chiều của channel (để ghép được thì các output phải có cùng [[Spatial Size]], tác là ta sẽ áp dụng [[Same Convolution]] và khi thực hiện [[Pooling Layer]] phải có thêm padding)
