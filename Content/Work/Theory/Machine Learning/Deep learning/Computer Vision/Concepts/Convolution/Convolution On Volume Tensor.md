...
$$z=z_1​+z_2​+z_3​+b$$
> [!note]
> khi thực hiện tích chập một filter có kích thước (n, n, n_c) lên tensor có kích thước (h, w, n_c) ta sẽ nhận được một [[Feature Map F]] có kích thước (x, x, 1) (xem trong [[]])
