...
# Công dụng trong ML
gradient descent được áp dụng vào việc cập nhật các tham số của [[Neural Network]] như [[Weight]], [[Content/Work/Theory/Machine Learning/Fundamentals/Quantities/Bias]], ... 
...
- J là [[Content/Work/Theory/Machine Learning/Fundamentals/Concepts/Cost Function]] 
- $L_{i}$ là [[Loss Function]] của mẫu thứ i trong batch 