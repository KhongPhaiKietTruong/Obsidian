...
lưu ý: cấp bậc của [[Matrix (Ma Trận)]] dùng để tính toán toán trong [[Neural Network]] to nhất chỉ là layer chứ không có một ma trận nào biểu diễn cho toàn bộ mạng neural cả 