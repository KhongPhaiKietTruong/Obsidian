...
[[Hypothesis]] của ta có dạng: $$f_{\vec{w}, b}(\vec{x}) = w_{1} x_{1} + w_{2}x_{2} + b$$ta có [[Content/Work/Theory/Machine Learning/Fundamentals/Concepts/Cost Function]] (giả sử ta dùng [[Mean Squared Error Cost Function (MSE)]]) là:
$$ 
...
$$
khiến việc update [[Weight]] bằng [[Gradient Descent]] diễn ra có sự lệch rất lớn khi w1 thì update một khoảng lớn trong khi w2 lại được update một khoảng rất nhỏ
