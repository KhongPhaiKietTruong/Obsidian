...
cách hoạt động nôm na của [[Neural Network]] là khi mỗi mẫu đi qua mạng neural, thì mạng neural đó sẽ cho ra [[Predicted Value]], từ cái kết quả dự đoán đó ta tính ra được [[Content/Work/Theory/Machine Learning/Fundamentals/Concepts/Loss function|Loss Function]] của mẫu đó, sau đó ta tính mức độ đóng góp của [[Weight (Trọng Số)|trọng số w]] vào Loss và [[Content/Work/Theory/Machine Learning/Fundamentals/Metrics/Bias| bias b]] vào loss, nếu như mức độ đóng góp của w và b vào loss lớn thì giá trị update ([[Gradient Descent]]) của w và b cũng to theo để điều chỉnh model sao cho ra kết quả gần với mẫu hiện tại (đưa vào tất cả mẫu nên model cuối cùng sẽ là "trung hòa" giữa sự update w, b của các mẫu)
