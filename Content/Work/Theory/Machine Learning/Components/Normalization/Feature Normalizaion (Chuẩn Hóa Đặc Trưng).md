...
$$
khiến việc update [[Weight (Trọng Số) w]] bằng [[Gradient Descent]] diễn ra có sự lệch rất lớn khi w1 thì update một khoảng lớn trong khi w2 lại được update một khoảng rất nhỏ
