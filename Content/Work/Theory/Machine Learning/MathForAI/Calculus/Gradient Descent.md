...
# Công dụng trong ML
gradient descent được áp dụng vào việc cập nhật các tham số của [[Neural Network (Mạng Neural)]] như [[Weight w]], [[Content/Work/Theory/Machine Learning/Foundations/Components/Metrics/Bias]], ... 
