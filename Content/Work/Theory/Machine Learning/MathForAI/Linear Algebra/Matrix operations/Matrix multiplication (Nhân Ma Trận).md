điều kiện để hai [[Matrix (Ma Trận)]] nhân được với nhau là số cột của ma trận đứng trước bằng với số hàng của ma trận đứng sau, tức: 
$$
(r_{1}, c_{1}) \times (r_{2}, c_{2}) = (r_{1}, c,2 )
$$  
