ta thực hiện forward pass bằng cách truyền [[Training Set]] vào [[Instance (Thể hiện)]] của cái class [[Neural Network (Mạng Neural)]] mà ta đã định nghĩa (cái mà kế thừa từ [[nn.Module]], ...) 
