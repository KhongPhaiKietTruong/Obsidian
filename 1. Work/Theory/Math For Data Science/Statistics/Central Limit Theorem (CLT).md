...
$$\mu_{\bar{x}} = \mu$$
- độ lệch chuẩn của các trung bình mẫu sẽ bằng độ lệch chuẩn của quần thể gốc chia cho căn của n:
$$\sigma_{\bar{x}} = \frac{\sigma}{\sqrt{n}}$$
ví dụ: ta tung 3 xúc sắc 6 mặt, mỗi lần tung ta sẽ có một mẫu, mỗi mẫu ta tính trung bình mẫu, sau khi tung rất nhiều lần, vẽ lên đồ thị thì sẽ có hình chuông