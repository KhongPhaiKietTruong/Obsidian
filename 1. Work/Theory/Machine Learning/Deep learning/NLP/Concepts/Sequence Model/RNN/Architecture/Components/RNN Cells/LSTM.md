...
là một biến thể của [[Vanilla RNN Cell]], cũng giúp giảm bớt vấn đề [[Vanishing Gradient]] của [[Vanilla RNN]], cũng khá tương tự với [[GRU]] có 2 gate thì LSTM có 3 gate, mỗi gate điều khiển một vấn đề riêng:
