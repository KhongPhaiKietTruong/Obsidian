...
là một biến thể của [[Vanilla RNN Cell]], hoặc cũng có thể gọi là biến thể của [[Vanilla RNN]], GRU thường nhẹ và nhanh hơn [[LSTM]] do ít gate hơn (tính toán ít hơn) nhưng đánh đổi lại là "lượng nhớ" những thông tin cũ sẽ không bằng 
