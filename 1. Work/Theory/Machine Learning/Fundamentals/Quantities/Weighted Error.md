khi các chỉ số đánh giá như [[Precision (Độ chính xác)]], [[Recall (Độ Bao Phủ)]] hay [[F1 Score]] không thể đánh giá được hết những điều mà ta thật sự quan tâm trong thực tế của model 
