...
## Vị Trí Sử Dụng
- Thường nằm đằng sau [[Activation Layer]] 
## Drop Out ở Test Time 
giả sử mạng neural ta có thực hiện dropout với prob_keep = 75% thì mỗi layer cho ra 0.75A thì mà [[Weight]] mà ta học được cũng tương ứng theo giá trị A đó, khi ta thực hiện [[Inference - Test time]] thì sẽ không có thành phần dropout thì mỗi layer cho ra A, điều này dẫn đến ta áp dụng các trọng số học được từ 0.75A lên A (từ lớp trước truyền đến) gây ra sự **không khớp** khiến mô hình dự đoán rất tệ do đó ta sẽ tắt drop out ở test time