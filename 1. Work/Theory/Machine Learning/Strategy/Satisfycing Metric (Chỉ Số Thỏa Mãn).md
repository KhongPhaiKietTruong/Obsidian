...
ví dụ như: thời gian inference chỉ cần < 100 ms là oke, không cần phải chọn model mà có chỉ số đó nhỏ nhất (lưu ý là còn xét các đại lượng đánh giá khác nữa, điển hình là [[Optimizing Metric (Chỉ Số Tối Ưu)]])
