...
- [[1. Work/Languages/Python/Third-Party/Numpy/Attribute/shape|Shape]] - Kích thước/hình dạng của mảng (đối với ma trận 2D: chiều cao, chiều rộng)
- [[ndim]] - Số chiều của mảng
- [[1. Work/Languages/Python/Third-Party/Numpy/Attribute/size]] - Tổng số phần tử trong mảng
...
- [[1. Work/Languages/Python/Third-Party/Numpy/Attribute/Inverse matrix| Inverse]] - Khái niệm/hình ảnh về ma trận chuyển vị
...
- [[Vectorization|Vectorization]] - Vectơ hóa các phép toán
- [[linalg.det()|linalg.det()]] - Tính định thức của ma trận
- [[linalg.inv()|linalg.inv()]] - Tìm ma trận nghịch đảo
- [[linalg.norm()|linalg.norm()]] - Tính chuẩn (norm) của vectơ/ma trận
- [[linalg.solve()|linalg.solve()]] - Giải hệ phương trình tuyến tính
